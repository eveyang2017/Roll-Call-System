...
var tableInit = {
    ...
    Init_Stu: function () {
        ...
        this.myViewModel = new ko.bootstrapTableViewModel({
            url: "/api/get_place/",         //请求后台的URL（*）
            method: 'GET',                      //请求方式（*）
            toolbar: '#get_place',                //工具按钮用哪个容器
        ...
        ko.applyBindings(this.myViewModel, document.getElementById("tb_place"));
    }
};
...
var operate = {
    ...
    operateSave: function () {
        $('#btn_submit').on("click", function () {
            ...
            var funcName = oDataModel.id?"update_place/":"add_place/";
            $.ajax({
                url: "/api/"+funcName,
                type: "post",
                data: oDataModel,
